...
function caratiq_get_authorization_url()
{
    ...
    $auth_url = "https://caratiqdemo.com/woocommerce-auth?redirect_uri=$redirect_uri";
    return $auth_url;
}
...
function caratiq_verify_authorization_code($authorization_code)
{
    ...
    $api_url = 'https://caratiqdemo.com/api/verify-auth-code';
...
function caratiq_create_customer_key($token)
{
    ...
    $api_url = 'https://caratiqdemo.com/api/verify-woo-token';
